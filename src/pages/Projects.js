...
const Projects = () => {
  ...
  const projects = [
    {img: myPortfolio, href: 'https://github.com/majocast/personal-website', techs: [BiLogoReact, BiLogoJavascript, BiLogoHtml5, BiLogoTailwindCss], name: 'marccastro.onrender.com', desc: 'A solo-developed personal portfolio to showcase my identity, accomplishments, and selected projects. Process included sketches, rough drafting, quality assurance and user central design review via having colleagues, recruiters and advisors navigate the website.'},
    {img: onTheGrind, href: 'https://onthegrind.onrender.com/', techs: [BiLogoMongodb, SiExpress, BiLogoReact, BiLogoNodejs, BiLogoJavascript, SiAxios, BiLogoHtml5, BiLogoTailwindCss], name: 'On The Grind', desc: 'A full stack e-commerce website that allows users to view the products that the company known as "On The Grind" have to offer! Users can navigate the page, sign in or create an account, add items to their cart, place an order, and so much more.'},
    {img: semiWrapped, href: 'https://semiwrapped.onrender.com', techs: [BiLogoReact, SiExpress, SiAxios, BiLogoHtml5, BiLogoCss3, BiLogoBootstrap, BiLogoSpotify, BiLogoJavascript ], name: 'Semi Wrapped', desc: 'A web application made using the Spotify API that allows users to log in with their spotify premium account and look through the past 6 months of data in a concise and sorted manner. Users shall be able to see their genre pool and top artists and songs. It is currently awaiting quota extension from Spotify.'},
    {img: crisisConnect, href: 'https://github.com/CSC-648-SFSU/csc648-02-sp2023-team04', techs: [BiLogoReact, BiLogoHtml5, BiLogoCss3, BiLogoJavascript, BiLogoAws], name: 'Crisis Connect', desc: 'An industry-grade, Beta-level launch of a crisis alert web application that shall allow you to see Weather & Fire, Health, and Security updates uploaded directly by county officials. You can view and filter the map for updates across California, register/login to access capabilities to recieve personalized updates, and more.'},
    {img: weatherApp, href: 'https://majocast.github.io/weather-app-react/', techs: [BiLogoReact, BiLogoHtml5, BiLogoCss3, BiLogoJavascript, SiAxios], name: 'Weather App', desc: 'A little weather app that allows for city search using the openweathermap.org Weather API. Website displays the current temperature, the cloud coverage, any weather like thunderstorms or rain, humidity, and wind speed. It also displays the resulting city from the search.'},
  ]
  return (
    <div id='projects' className='min-h-screen flex flex-col items-center'>
      ...
      {projects.map(project => {
        ...
        return (
          <a className='grid grid-cols-2 w-4/5 text-center pb-2 pr-2 my-2 rounded-xl border-b-2 border-r-2 border-[#E0A526]' href={project.href} target='_blank' rel='noopener noreferrer'>
